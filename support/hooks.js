/**
 * This area is for the `post` execution of tests. In this case, HTML reports are generated to the Reports folder
 */

var Cucumber = require('cucumber');
var fs = require('fs');
var conf = require('../protractor.config.js').config;
...
var hooks = function () {
    ...
    this.registerHandler('AfterFeature', function (event, callback) {
        ...
        // Here all the post feature method calls are done
